...
class HistoryWindow(ctk.CTkToplevel):
    ...
    def _apply_filters(self) -> None:
        ...
        filtered = filter(date_filter, filtered)
    ...
    def _update_filtered_entries(self, filtered_entries: List[TranslationEntry]) -> None:
    ...
    def _create_entry_widgets(self, frame: ctk.CTkFrame, entry: TranslationEntry) -> dict:
        ...
        try:
            ...
            preview = entry.translated_text[:PREVIEW_LENGTH] + "..." if len(entry.translated_text) > PREVIEW_LENGTH else entry.translated_text
