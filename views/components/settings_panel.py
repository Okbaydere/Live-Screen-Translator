...
class SettingsPanel(ctk.CTkFrame):
    ...
    def _create_general_tab(self):
        ...
        ctk.CTkLabel(window_frame, text="Window Settings").pack(anchor="w", padx=5, pady=2)
        ...
        shortcuts_switch = ctk.CTkSwitch(
            ...
            command=lambda: self.on_toggle_global_shortcuts(self.global_shortcuts_var.get())
        )
    ...
    def _create_translation_tab(self):
        ...
        ctk.CTkLabel(engine_frame, text="Translation Engine").pack(anchor="w", padx=5, pady=2)
        ...
        ctk.CTkLabel(ocr_frame, text="OCR Engine").pack(anchor="w", padx=5, pady=2)
    ...
    def _create_appearance_tab(self):
        ...
        ctk.CTkLabel(opacity_frame, text="Window Opacity").pack(anchor="w", padx=5, pady=2)
